import React, { FC, FormEvent, ReactNode, useMemo, useState } from 'react';
...
const CustomForm: FC<IProps> = ({ disabled, title, subtitle, fields, onSubmit, submitButton, errors, oauthAction }) => {
...
const connector = connect(null, { oauthAction: oauth });

type PropsFromRedux = ConnectedProps<typeof connector>

export default connector(CustomForm);
